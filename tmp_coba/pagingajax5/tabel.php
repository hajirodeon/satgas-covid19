...
var pageku = $("#pagesetnya5").val();


$.ajax({
	url: "<?php echo $filenyax45;?>?aksi=form&pageku="+pageku,
	type:$(this).attr("method"),
	data:$(this).serialize(),
	success:function(data){					
...
$.ajax({
	url: "<?php echo $filenyax45;?>?aksi=jmldatanya",
	type:$(this).attr("method"),
	data:$(this).serialize(),
	success:function(data){					
		$("#ijmldatanya5").html(data);
		}
	});
...
$("#cariku5").on('keyup', function(){
		var limitku = $("#pagesetnya5").val();
    	var cariku = $("#cariku5").val();

		$.ajax({
			url: "<?php echo $filenyax45;?>?aksi=form&limitku5="+limitku+"&cariku5="+cariku,
			type:$(this).attr("method"),
			data:$(this).serialize(),
			success:function(data){					
				$("#idetailtable5").html(data);
...
$("#pagesetnya5").on('change', function(){
	var limitku = $("#pagesetnya5").val();


	$.ajax({
		url: "<?php echo $filenyax45;?>?aksi=form&limitku5="+limitku,
		type:$(this).attr("method"),
		data:$(this).serialize(),
		success:function(data){					
			$("#idetailtable5").html(data);
...
<div class="row">
	...
	<div class="col-md-12" id="ijmldatanya5">
			<img src="../../img/progress-bar.gif" width="150" />
	</div>
...
<div class="row">
	...
	<div class="col-md-10">
		...
		<select name="pagesetnya5" id="pagesetnya5" class="btn btn-warning">
			<option value="10" selected>10</option>
			<option value="30">30</option>
			<option value="50">50</option>
			<option value="100">100</option>
	...
	<div class="col-md-2">
		...
		<input type="text" class="btn btn-block btn-warning" name="cariku5" id="cariku5" placeholder="Cari...">
