...
<h3 class="box-title">GRAFIK TIPE USER</h3>
</div>
...
<div class="box-body">
	...
	<div class="card-footer clearfix">
	  <b>Total : <?php echo $tku2;?></b> User.
	  
	  <a href="pegawai/grafik_tipe_user.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	</div>
	<!-- /.box-footer -->
