...
<div class="box-header with-border">
  <h3 class="box-title">REALTIME HISTORY USER LOGIN</h3>
</div>
	  ...
	  <div class="table-responsive">
	    <table class="table no-margin">
	      ...
	      <tbody>
			...
			<?php
			//total
			$qku2 = mysqli_query($koneksi, "SELECT * FROM orang_login ".
	...
	<div class="card-footer clearfix">
	  ...
	  <a href="pegawai/history_login.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	</div>
