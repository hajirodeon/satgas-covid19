...
<h3 class="box-title">GRAFIK PANIC BUTTON : Tipe User Penolong</h3>
</div>
	...
	<div class="box-body">
			...
			<canvas id="demobar_panic4"></canvas>
	
	
	      	<script  type="text/javascript">
	
	    	  var ctx = document.getElementById("demobar_panic4").getContext("2d");
	    	  var data = {
	    	            labels: [
						<?php
						//query x-1
						...
						do 
							...
							//jml user e
							$qku2 = mysqli_query($koneksi, "SELECT DISTINCT(umum_sesi_penolong.penolong_kd) AS total ".
						...
						do 
							...
							$qku2 = mysqli_query($koneksi, "SELECT DISTINCT(umum_sesi_penolong.penolong_kd) AS total ".
															"FROM m_orang, umum_sesi_penolong ".
															"WHERE umum_sesi_panic.penolong_kd = m_orang.kd ".
															"AND m_orang.tipe_user = '$i_nama'");
							$rku2 = mysqli_fetch_assoc($qku2);
							$tku2 = mysqli_num_rows($qku2);
	...
	<?php
	//jml user e
	$qku2 = mysqli_query($koneksi, "SELECT DISTINCT(penolong_kd) AS total ".
	...
	<div class="card-footer clearfix">
	  ...
	  <a href="k/grafik_panic_button_tipe_penolong.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	</div>
	<!-- /.box-footer -->
