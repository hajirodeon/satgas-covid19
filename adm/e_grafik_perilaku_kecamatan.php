...
<h3 class="box-title">GRAFIK PERILAKU MASYARAKAT : PER KECAMATAN</h3>
</div>
...
<div class="card-footer clearfix">
  ...
  <a href="perilaku/grafik_perilaku_kecamatan.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
</div>
<!-- /.box-footer -->
