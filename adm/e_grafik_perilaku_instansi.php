...
<h3 class="box-title">GRAFIK PERILAKU MASYARAKAT : FORWARD INSTANSI</h3>
</div>
...
<div class="box-body">
	    ...
	    labels: [<?php
	        ...
	        data: [<?php
					...
					do 
						...
						//jml
						$qyuk41 = mysqli_query($koneksi, "SELECT DISTINCT(orang_kd) AS totalku ".
															"FROM perilaku_satgas ".
															"WHERE orang_tipe = '$i_nama'");
	...
	<?php
	//jml kasus
	$qku2 = mysqli_query($koneksi, "SELECT DISTINCT(orang_kd) AS totalku ".
										"FROM perilaku_satgas");
	...
	<div class="card-footer clearfix">
	  ...
	  <a href="perilaku/grafik_perilaku_instansi.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	</div>
	<!-- /.box-footer -->
