...
<h3 class="box-title">GRAFIK PERILAKU MASYARAKAT : PER JUMLAH JAGA JARAK</h3>
</div>
...
for($i=0; $i<=7; $i++)
	...
	//ketahui ordernya...
	$qyuk = mysqli_query($koneksi, "SELECT SUM(jml_jagajarak) AS totalku ".
...
for($i=0; $i<=7; $i++)
	...
	//ketahui ordernya...
	$qyuk = mysqli_query($koneksi, "SELECT SUM(jml_jagajarak_tidak) AS totalku ".
							"FROM e_perilaku_masyarakat ".
							"WHERE round(DATE_FORMAT(postdate, '%d')) = '$itgl' ".
							"AND round(DATE_FORMAT(postdate, '%m')) = '$ibln' ".
							"AND round(DATE_FORMAT(postdate, '%Y')) = '$itahun'");
...
<script>
  $(function () {
    ...
    var areaChartCanvas = $('#areaChartp2_jagajarak').get(0).getContext('2d')
    ...
    areaChart.Line(areaChartData, areaChartOptions)
	            ...
	            <div class="box-body">
					...
					<div class="chart">
					<canvas id="areaChartp2_jagajarak" style="height:250px"></canvas>
					</div>
				...
				//ketahui 
				$qyuk2 = mysqli_query($koneksi, "SELECT SUM(jml_jagajarak_tidak) AS totalku ".
										"FROM e_perilaku_masyarakat");
	            ...
	            <div class="card-footer clearfix">
	              <font color="orange"><b><?php echo $yuk_total;?></b> Jaga Jarak</font>. 
	              
	              <font color="red"><b><?php echo $yuk2_total;?></b> Tidak Jaga Jarak</font>.
	               
	              <a href="perilaku/grafik_perilaku_jml_jagajarak.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	            </div>
