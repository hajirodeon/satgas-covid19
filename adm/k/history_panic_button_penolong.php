...
//nilai
$filenya = "history_panic_button_penolong.php";
$judul = "HISTORY : PENOLONG";
            ...
            <div class="bs-callout bs-callout-primary">
				...
				echo '<form action="'.$filenya.'" method="post" name="formx">
					...
					<thead>
				        <tr valign="top" bgcolor="'.$warnaheader.'">
					            <th><strong><font color="'.$warnatext.'">POSTDATE_PENUGASAN</font></strong></th>
								...
								<th><strong><font color="'.$warnatext.'">KATEGORI MASALAH</font></strong></th>
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_history_panic_button_penolong_data.php'
				        },
				        'columns': [
          ...
          <div class="bs-callout bs-callout-info">
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable2').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_history_panic_button_penolong_data_belum.php'
				        },
				        'columns': [
				            { data: 'tugaskan_postdate' },
				            { data: 'penolong_nama' },
          ...
          <div class="bs-callout bs-callout-warning">
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable3').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_history_panic_button_penolong_data_proses.php'
				        },
				        'columns': [
				            { data: 'tugaskan_postdate' },
				            { data: 'penolong_nama' },
          ...
          <div class="bs-callout bs-callout-success">
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable4').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_history_panic_button_penolong_data_selesai.php'
				        },
				        'columns': [
				            { data: 'tugaskan_postdate' },
				            { data: 'penolong_nama' },
          ...
          <div class="bs-callout bs-callout-danger">
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable5').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_history_panic_button_penolong_data_prank.php'
				        },
				        'columns': [
				            { data: 'tugaskan_postdate' },
				            { data: 'penolong_nama' },
