...
//nilai
$filenya = "grafik_panic_button_tgl.php";
$judul = "PER TANGGAL";
    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="semua" name="semua" role="tabpanel">
            <div class="bs-callout bs-callout-primary">
				...
				//ketahui ordernya...
				$qyuk2 = mysqli_query($koneksi, "SELECT DISTINCT(panic_kd) AS totalku ".
				...
				<a id="link" download="grafik_panic_button_tgl-'.$e_tgl1.'-sampai-'.$e_tgl2.'.png" class="btn btn-success">UNDUH GRAFIK IMAGE >></a>
				
				<a href="grafik_panic_button_tgl_xls.php?e_tgl1='.$e_tgl12.'&e_tgl2='.$e_tgl22.'" class="btn btn-danger">EXPORT EXCEL >></a>
				<hr>
				...
				$(document).ready(function(){
				    ...
				    var table = $('#empTable').DataTable({
				        ...
				        'serverMethod': 'post',
				        'ajax': {
				            'url':'i_grafik_panic_button_tgl_data.php?e_tgl1=<?php echo $e_tgl12;?>&e_tgl2=<?php echo $e_tgl22;?>'
				        },
				        'columns': [
				            { data: 'postdate' },
				            { data: 'korban' },
