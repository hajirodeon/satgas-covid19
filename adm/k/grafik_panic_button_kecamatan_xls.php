...
//nilai
$filenya = "grafik_panic_button_kecamatan_xls.php";
$judul = "PER KECAMATAN";
...
$sheet = $excel->getActiveSheet()->setTitle('kecamatan');
...
TIDAK_DITOLONG");
  ...
  //list kecamatan
	...
	do 
		...
		//total
		$qyuu = mysqli_query($koneksi, "select * from panic_kec_total ".
...
$ke = "lap_panic_button_per_kecamatan.xlsx";
