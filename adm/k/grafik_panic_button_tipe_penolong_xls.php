...
//nilai
$filenya = "grafik_panic_button_tipe_penolong_xls.php";
...
$sheet = $excel->getActiveSheet()->setTitle('tipe_penolong');
...
$sheet->setCellValue('A2', 'PER TIPE USER PENOLONG, '.$tgl1_postdate.' SAMPAI '.$tgl2_postdate.'');
...
// header Background color
  ...
  //list 
	...
	do 
		...
		//total
		$qyuu = mysqli_query($koneksi, "select * from panic_tipe_penolong ".
...
$ke = "lap_panic_button_per_tipe_penolong-$tgl1_postdate-sampai-$tgl2_postdate.xlsx";
