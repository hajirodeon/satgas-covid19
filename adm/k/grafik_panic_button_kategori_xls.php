...
//nilai
$filenya = "grafik_panic_button_kategori_xls.php";
...
$sheet = $excel->getActiveSheet()->setTitle('kategori_masalah');
...
$sheet->setCellValue('A2', 'PER KATEGORI MASALAH, '.$tgl1_postdate.' SAMPAI '.$tgl2_postdate.'');
...
// header Background color
  ...
  //list 
	...
	do 
		...
		//total
		$qyuu = mysqli_query($koneksi, "select * from panic_kategori_masalah ".
...
$ke = "lap_panic_button_per_kategori_masalah-$tgl1_postdate-sampai-$tgl2_postdate.xlsx";
