...
$sheet = $excel->getActiveSheet()->setTitle('lap_perilaku_per_tempat');
...
$sheet->setCellValue('A2', 'PER KATEGORI TEMPAT');
...
// header Background color
  ...
  // menampilkan data 
  $sql = "SELECT * FROM e_m_kategori_tempat ".
  			"ORDER BY nama ASC";
...
$ke = "lap_perilaku_per_tempat.xlsx";
