...
//nilai
$filenya = "grafik_perilaku_jml_masker_xls.php";
$judul = "PER JML MASKER";
...
$sheet = $excel->getActiveSheet()->setTitle('lap_perilaku_per_jml_masker');
...
$sheet->setCellValue('A2', 'PER JUMLAH PENGGUNA MASKER');
...
// header Background color
  ...
  $sheet->setCellValue('B4', 'MEMAKAI_MASKER');
  $sheet->setCellValue('C4', 'TIDAK_MEMAKAI_MASKER');
  ...
  while ($row = mysqli_fetch_array($rs)) 
    ...
    $sheet->setCellValue('B'.$i, $yuk_masker_pake);
    $sheet->setCellValue('C'.$i, $yuk_masker_tidak);
...
$ke = "lap_perilaku_jml_masker-$tgl1_postdate-sampai-$tgl2_postdate.xlsx";
