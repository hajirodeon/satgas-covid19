...
<a id="link" download="grafik_perilaku_kategori.png" class="btn btn-success">UNDUH GRAFIK IMAGE >></a>

<a href="grafik_perilaku_kategori_xls.php" class="btn btn-danger">EXPORT EXCEL >></a>
<hr>';
...
$(document).ready(function(){
    ...
    var table = $('#empTable').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'i_grafik_perilaku_kategori_data.php?ekat=<?php echo $ekat;?>'
        },
        'columns': [
            { data: 'postdate' },
            { data: 'nama_lokasi' },
