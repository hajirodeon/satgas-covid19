...
//nilai
$filenya = "grafik_perilaku_jml_jagajarak_xls.php";
$judul = "PER JML JAGA JARAK";
...
$sheet = $excel->getActiveSheet()->setTitle('lap_perilaku_per_jml_jagajarak');
...
$sheet->setCellValue('A2', 'PER JUMLAH JAGA JARAK');
...
// header Background color
  ...
  $sheet->setCellValue('B4', 'JAGAJARAK');
  $sheet->setCellValue('C4', 'TIDAK_JAGAJARAK');
  ...
  while ($row = mysqli_fetch_array($rs)) 
	...
	//hitung total
	$qyuk = mysqli_query($koneksi, "SELECT SUM(jml_jaga_jarak) AS total_jagajarak, ".
										"SUM(jml_jaga_jarak_tidak) AS total_jagajarak_tidak ".
										"FROM e_perilaku_masyarakat ".
										"WHERE postdate LIKE '$i_tglku%'");
	$ryuk = mysqli_fetch_assoc($qyuk);
	$yuk_jagajarak = balikin($ryuk['total_jagajarak']);
	$yuk_jagajarak_tidak = balikin($ryuk['total_jagajarak_tidak']);
    ...
    $sheet->setCellValue('B'.$i, $yuk_jagajarak);
    $sheet->setCellValue('C'.$i, $yuk_jagajarak_tidak);
...
$ke = "lap_perilaku_jml_jagajarak-$tgl1_postdate-sampai-$tgl2_postdate.xlsx";
