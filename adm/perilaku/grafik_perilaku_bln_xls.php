...
//nilai
$filenya = "grafik_perilaku_bln_xls.php";
$judul = "PER BULAN";
...
$sheet = $excel->getActiveSheet()->setTitle('lap_perilaku_per_bln');
...
$ke = "lap_perilaku-bln-$tgl1_thn-$tgl1_bln-sampai-$tgl2_thn-$tgl2_bln.xlsx";
