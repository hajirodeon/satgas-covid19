...
//nilai
$filenya = "grafik_perilaku_jml_masker.php";
$judul = "PER JUMLAH MASKER";
...
for($i=0; $i<=$diffnya; $i++)
	...
	//ketahui ordernya...
	$qyuk = mysqli_query($koneksi, "SELECT DISTINCT(jml_masker_pake) AS totalku ".
...
for($i=0; $i<=$diffnya; $i++)
	...
	//ketahui 
	$qyuk = mysqli_query($koneksi, "SELECT DISTINCT(jml_masker_tidak) AS totalku ".
							"FROM e_perilaku_masyarakat ".
...
<input name="btnTPL" type="submit" value="TAMPILKAN >>" class="btn btn-danger">
	...
	<p>
          <font color="orange"><b>'.$yuk1_masker.'</b> Orang Memakai Masker</font>.
    </p>
    
	<p>
			<font color="red"><b>'.$yuk1_masker_tidak.'</b> Orang Tidak Memakai Masker</font>.
	</p>
...
<a id="link" download="grafik_perilaku_jml_masker-'.$e_tgl1.'-sampai-'.$e_tgl2.'.png" class="btn btn-success">UNDUH GRAFIK IMAGE >></a>



<a href="grafik_perilaku_jml_masker_xls.php?e_tgl1='.$e_tgl12.'&e_tgl2='.$e_tgl22.'" class="btn btn-danger">EXPORT EXCEL >></a>
<hr>
...
$(document).ready(function(){
    ...
    var table = $('#empTable').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'i_grafik_perilaku_jml_masker_data.php?e_tgl1=<?php echo $e_tgl12;?>&e_tgl2=<?php echo $e_tgl22;?>'
        },
        'columns': [
            { data: 'postdate' },
