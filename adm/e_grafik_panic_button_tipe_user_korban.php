...
<h3 class="box-title">GRAFIK PANIC BUTTON : Tipe User Korban</h3>
</div>
...
<div class="box-body">
		...
		<canvas id="demobar_panic3"></canvas>


      	<script  type="text/javascript">

    	  var ctx = document.getElementById("demobar_panic3").getContext("2d");
    	  var data = {
    	            labels: [
					<?php
					//query x-1
					...
					do 
						...
						//jml user e
						$qku2 = mysqli_query($koneksi, "SELECT DISTINCT(umum_sesi_panic.umum_kd) AS total ".
	...
	<div class="card-footer clearfix">
	  ...
	  <a href="k/grafik_panic_button_tipe_korban.php" target="_parent" class="btn btn-sm btn-danger float-right">SELENGKAPNYA >></a>
	</div>
	<!-- /.box-footer -->
