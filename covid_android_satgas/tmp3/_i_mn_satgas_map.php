...
//nilai
$filenya = "$sumber/covid_android_satgas/i_mn_satgas_map.php";
$filenyax = "$sumber/covid_android_satgas/i_mn_satgas_map.php";
$judul = "Data Satgas MAP";
$juduli = $judul;
...
function pentol() 
	{
	  ...
	  $.getJSON('i_mn_satgas_map_i_display.php', function(data) { 
