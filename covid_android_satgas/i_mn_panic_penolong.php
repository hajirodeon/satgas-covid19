...
//nilai
$filenya = "$sumber/covid_android_satgas/i_mn_panic_penolong.php";
$filenyax = "$sumber/covid_android_satgas/i_mn_panic_penolong.php";
$judul = "Data PENOLONG";
$juduli = $judul;
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#empTable').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url':'<?php echo $sumber;?>/covid_android_satgas/i_mn_panic_penolong_i_data.php'
            },
            'columns': [
                { data: 'nip' },
                { data: 'nama' },
