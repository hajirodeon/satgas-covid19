...
//nilai
$filenya = "$sumber/covid_android_satgas/i_mn_umum_map.php";
$filenyax = "$sumber/covid_android_satgas/i_mn_umum_map.php";
$judul = "Data UMUM MAP";
$juduli = $judul;
...
function pentol() 
	{
	  ...
	  $.getJSON('i_mn_umum_map_i_display.php', function(data) { 
