...
<?php
//jml semua
$qku2x = mysqli_query($koneksi, "SELECT SUM(jml_total) AS totalku ".
									"FROM perilaku_lap_bln");
...
//tampilkan
$qku = mysqli_query($koneksi, "SELECT * FROM perilaku_lap_bln ".
								"ORDER by bulan DESC");
