...
$sel = mysqli_query($koneksi,"select tanggal from panic_tipe_penolong");
...
$sel = mysqli_query($koneksi,"select * from panic_tipe_penolong ".
								"WHERE 1 ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
...
## Fetch records
$empQuery = "select * from panic_tipe_penolong ".
