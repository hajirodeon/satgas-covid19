			...
			<div class="row">
				<div class="col-md-12">
					...
					<p>
						Jumlah Orang : 
						<br>
						<input name="e_jml_orang" id="e_jml_orang" type="text" class="btn btn-warning" required>
					</p>
					...
					<p>
						...
						<br>
						<input name="e_masker_pakai" id="e_masker_pakai" type="text" class="btn btn-warning" required>
					</p>
					
					<p>
						Jumlah Tidak Memakai Masker : 
						<br>
						<input name="e_masker_tidak" id="e_masker_tidak" type="text" class="btn btn-warning" required>
					</p>
					...
					<p>
						Jumlah Jaga Jarak : 
						<br>
						<input name="e_jaga_jarak" id="e_jaga_jarak" type="text" class="btn btn-warning" required>
					</p>
					
					<p>
						Jumlah Tidak Jaga Jarak : 
						<br>
						<input name="e_jaga_jarak_tidak" id="e_jaga_jarak_tidak" type="text" class="btn btn-warning" required>
					</p>
					...
					<p>
						Jumlah Diingatkan : 
						<br>
						<input name="e_diingatkan" id="e_diingatkan" type="text" class="btn btn-warning" required>
					</p>
					
					<p>
						Jumlah Tidak Diingatkan : 
						<br>
						<input name="e_diingatkan_tidak" id="e_diingatkan_tidak" type="text" class="btn btn-warning" required>
					</p>
...
if ((isset($_GET['aksi']) && $_GET['aksi'] == 'foto'))
	...
	<img src="'.$sumber.'/filebox/perilaku/'.$kd.'/'.$new_image_name.'" class="img-thumbnail" width="250px" height="200px">
	</div>';
	*/
